 ...
 * @author HP
 */
public final class AddMyPrSI extends javax.swing.JInternalFrame {

    /**
     * Creates new form AddMyPrSI
     */
    public AddMyPrSI() {
        initComponents();
    ...
    public void playTableCours(){
       ...
       ResultSet r=connexiondata.extraireData("select n_cours,annee,n_heure,credit,semestre from cours where s_inf='"+true+"'order by annee");
        try {
            while(r.next()){
   ...
   //ici je veux retourner cle primaire de la table cours
    int getPrimaryCours(){
       ...
       ResultSet resulta=connexiondata.extraireData("select idCours from cours where s_inf='"+true+"'&& n_cours='"+nomcours+"'&& annee='"+annee+"'");
        try {
            while(resulta.next()){
 ...
 //  je  veux retourner la valeur vraie si la ligne de la table des cours a ete selectionne
  boolean selectedTableCours(){
    ...
    private void initComponents() {
        ...
        jScrollPane3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Liste des  professeurs en Soins Infirmier et leurs cours", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 11))); // NOI18N
        ...
        jScrollPane2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Liste des cours du Soin Infirmier(SI)", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 12))); // NOI18N
        ...
        radio_Relier1.setForeground(new java.awt.Color(0, 0, 153));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(58, 58, 58)
                .addComponent(radio_Relier1, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(radio_Relier, javax.swing.GroupLayout.PREFERRED_SIZE, 77, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        tr_select.setText("Liste des  professeurs en Soins Infirmier et leurs cours");
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(tr_select, javax.swing.GroupLayout.PREFERRED_SIZE, 308, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGap(81, 81, 81)
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        if(isSelectedyes()) {
            ...
            if(all_select.isSelected()){
                if(JOptionPane.showConfirmDialog(this,"Vous voulez imprimer?"+" "+s4)==JOptionPane.OK_OPTION)
                {
                    ...
                    JOptionPane.showMessageDialog(this, "effectuée"+" .La liste des cours de la SI suive");
                    gerer_fenetre.export(tb_cours,ext);
                    JOptionPane.showMessageDialog(this, "effectuée"+" .La liste des Professeurs de la SI et ses cours suive");
                    gerer_fenetre.export(tb_ensCours,ext);
    ...
    private void jLabel7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7MouseClicked
        srchCours.setText(""+getPrimaryCours());        
...
public void chargerEnsCours(){
    ...
    ResultSet info=connexiondata.extraireData("select n_cours,annee,n_heure,nom,prenom,date_modified from cours,personel,enseignant_cours "
            + "where (cours.s_inf='"+true+"' and cours.idCours=enseignant_cours.idCours and personel.idEmployer=enseignant_cours.idProf )order by annee");
        try {
            while(info.next()){
...
//je veux savoir le nombre des tables à exporter sous différentes format   
    ...
    String s3=" la liste des  professeurs en Soins Infirmier et leurs cours";
  ...
  if(isSelectedyes()) { 
    ...
    if(all_select.isSelected()){
      if(JOptionPane.showConfirmDialog(this,"Vous voulez imprimer "+s4+" ?")==JOptionPane.OK_OPTION)
        {
             gerer_fenetre.ImprimerLaTable(tb_ens);
             JOptionPane.showMessageDialog(this, "effectuée"+" .La liste des cours du SI suive");
             gerer_fenetre.ImprimerLaTable(tb_cours);
             JOptionPane.showMessageDialog(this, "Effectuée"+" .La liste des Professeurs de la SI et ses cours suive");
             gerer_fenetre.ImprimerLaTable(tb_ensCours);
             JOptionPane.showMessageDialog(this, "C'est fini!Merci");
