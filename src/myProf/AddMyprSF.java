 ...
 * @author HP
 */
public final class AddMyprSF extends javax.swing.JInternalFrame {

    /**
     * Creates new form AddMyprSF
     */
    public AddMyprSF() {
        initComponents();
    ...
    public void playTableCours(){
       ...
       ResultSet r=connexiondata.extraireData("select n_cours,annee,n_heure,credit,semestre from cours where sage_fem='"+true+"' order by annee");
        try {
            while(r.next()){
   ...
   //ici je veux retourner cle primaire de la table cours
    int getPrimaryCours(){
       ...
       ResultSet resulta=connexiondata.extraireData("select idCours from cours where sage_fem='"+true+"'&& n_cours='"+nomcours+"'&& annee='"+annee+"'");
        try {
            while(resulta.next()){
 ...
 //  je  veux retourner la valeur vraie si la ligne de la table des cours a ete selectionne
  boolean selectedTableCours(){
    ...
    private void initComponents() {
        ...
        jScrollPane3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Liste des Professeurs en Sage Femme et leurs cours", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 11))); // NOI18N
        ...
        tr_select.setText("La liste des Professeurs en Sage Femme et leurs cours");
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(tr_select, javax.swing.GroupLayout.PREFERRED_SIZE, 312, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGap(81, 81, 81)
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jScrollPane2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Liste des cours en Sage Femme(SF)", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 12))); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(60, 60, 60)
                .addComponent(radio_Relier1, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(radio_Relier1, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(17, 17, 17))
        );
    ...
    private void radio_Relier1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_radio_Relier1ActionPerformed
        sagFemmeUI cdep=new sagFemmeUI();
...
public void chargerEnsCours(){
    ...
    ResultSet info=connexiondata.extraireData("select n_cours,annee,n_heure,nom,prenom,idEnregistrement,date_modified from cours,personel,enseignant_cours "
            + "where (cours.sage_fem='"+true+"' and cours.idCours=enseignant_cours.idCours and personel.idEmployer=enseignant_cours.idProf)order by annee");
        try {
            while(info.next()){
                Object ligne[]={info.getString("nom")+"  "+info.getString("prenom"),info.getString("n_cours"),info.getString("annee"),info.getString("n_heure"),
                info.getString("date_modified")};
                deft.addRow(ligne);
            }  
        } catch (SQLException ex) {
            Logger.getLogger(AddMyprSP.class.getName()).log(Level.SEVERE, null, ex);
...
//je veux savoir le nombre des tables à exporter sous différentes format   
    ...
    String s3=" la liste des  professeurs en Sage Femme et leurs cours";
