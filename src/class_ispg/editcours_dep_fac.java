 ...
 * @author HP
 */
public class editcours_dep_fac {
    ...
    return connexiondata.modifierDB("UPDATE cours(n_cours,sant_pub,sage_fem,dev_com,s_inf,annee,n_heure,credit,semestre,date_fixed,commentaire)"
