 ...
 * @author HP
 */
public class soinfTab extends javax.swing.JInternalFrame {

    /**
     * Creates new form soinfTab
     */
    public soinfTab() {
        initComponents();
    ...
    String str1=null,str2=null,str3=null,str4=null;
      ...
      void charg_tab_cour(){
        ...
        rset=connexiondata.extraireData("select *from cours where s_inf='"+true+"'");
   ...
   void play_tb_cours(){
       row=tab_cours.getSelectedRow();
        ...
        ResultSet rs=connexiondata.extraireData("select *from cours where n_cours='"+str1+"' && s_inf='"+true+"'&& annee='"+str2+"' && "
...
if(s.length()>0){
    ...
    private void initComponents() {
        ...
        tab_cours.setBackground(new java.awt.Color(51, 0, 0));
        tab_cours.setFont(new java.awt.Font("Calibri", 1, 11)); // NOI18N
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(50, 50, 50)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(txt_nhr_ed, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(txt_cr_ed, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(281, 281, 281)
                                .addComponent(btn_app, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(55, 55, 55)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(txt_cr_ed, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel6, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(30, 30, 30)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txt_nhr_ed, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(49, 49, 49)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(slctAnn)
                            .addComponent(jLabel9, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(31, 31, 31)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jLabel7, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(slctSmstr, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        if(str1!=null &str2!=null&str3!=null&str4!=null){
            ...
            if(str1!=null||str2!=null||str3!=null){
                if(JOptionPane.showConfirmDialog(this, "Voulez-vous supprimer le cours")==JOptionPane.OK_OPTION){
                    connexiondata.modifierDB("DELETE FROM cours WHERE n_cours='"+str1+"' &&s_inf='"+true+"' && annee='"+str2+"'"
        ...
        if(str1.length()>0 &&str2.length()>0&&str3.length()>0&&str4.length()>0){
            ...
            if(JOptionPane.showConfirmDialog(this, "Voulez-vous appliquer la modification?")==JOptionPane.OK_OPTION){
                ...
                connexiondata.modifierDB("UPDATE cours SET n_cours='"+txt_cours_ed.getText().toUpperCase()+"'"
                    ...
                    + "WHERE n_cours='"+str1+"'&& s_inf='"+true+"' && annee='"+str2+"' && n_heure='"+str3+"' && credit='"+str4+"' ");
                charg_tab_cour();
                btn_edit.setSelected(false);
                btn_ret.setSelected(false);
...
gerer_volumeHoraire();        // TODO add your handling code here:
    ...
    private void jRadioButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButton1ActionPerformed
        try {
            ...
            Logger.getLogger(soinfTab.class.getName()).log(Level.SEVERE, null, ex);
        }
