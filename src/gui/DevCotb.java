 ...
 * @author HP
 */
public final class DevCotb extends javax.swing.JInternalFrame {

    /** Creates new form DevCotb */
    public DevCotb() {
        initComponents();
    ...
    String str1=null,str2=null,str3=null,str4=null;
      ...
      void charg_tab_cour(){
        ...
        rset=connexiondata.extraireData("select *from cours where dev_com='"+true+"'");
   ...
   void play_tb_cours(){
       row=tab_cours.getSelectedRow();
        ...
        ResultSet rs=connexiondata.extraireData("select *from cours where n_cours='"+str1+"' && dev_com='"+true+"'&& annee='"+str2+"' && "
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(316, 316, 316)
                        .addComponent(btn_app, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(30, 30, 30)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txt_cours_ed, javax.swing.GroupLayout.DEFAULT_SIZE, 30, Short.MAX_VALUE)
        ...
        if(str1!=null &str2!=null&str3!=null&str4!=null){
            ...
            if(str1!=null||str2!=null||str3!=null){
                if(JOptionPane.showConfirmDialog(this, "Voulez-vous supprimer le cours")==JOptionPane.OK_OPTION){
                    connexiondata.modifierDB("DELETE FROM cours WHERE n_cours='"+str1+"' &&dev_com='"+true+"' && annee='"+str2+"'"
        ...
        if(str1!=null &str2!=null&str3!=null&str4!=null){
            if(JOptionPane.showConfirmDialog(this, "Voulez-vous appliquer la modification?")==JOptionPane.OK_OPTION){
                ...
                connexiondata.modifierDB("UPDATE cours SET n_cours='"+txt_cours_ed.getText().toUpperCase()+"'"
                    ...
                    + "WHERE n_cours='"+str1+"'&& dev_com='"+true+"' && annee='"+str2+"' && n_heure='"+str3+"' && credit='"+str4+"' ");
                charg_tab_cour();
                btn_edit.setSelected(false);
                btn_ret.setSelected(false);
